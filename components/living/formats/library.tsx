...
export function LetterView(p: StoryViewData) {
  return (
    <FormatShell variant="letter" accent={p.accent} artDirection={p.artDirection} seed={p.seed} blocks={p.blocks}
      header={p.chrome ? (
...
export function PosterView(p: StoryViewData) {
  return (
    <FormatShell variant="poster" accent={p.accent} artDirection={p.artDirection} seed={p.seed} blocks={p.blocks}
      header={p.chrome ? (
...
export function TicketView(p: StoryViewData) {
  return (
    <FormatShell variant="ticket" accent={p.accent} artDirection={p.artDirection} seed={p.seed} blocks={p.blocks}
      header={p.chrome ? (
...
export function NotebookView(p: StoryViewData) {
  return (
    <FormatShell variant="notebook" accent={p.accent} artDirection={p.artDirection} seed={p.seed} blocks={p.blocks}
      header={p.chrome ? (
...
export function GalleryView(p: StoryViewData) {
  return (
    <FormatShell variant="gallery" accent={p.accent} artDirection={p.artDirection} seed={p.seed} blocks={p.blocks}
      header={p.chrome ? (
...
export function FilmView(p: StoryViewData) {
  return (
    <FormatShell variant="film" accent={p.accent} artDirection={p.artDirection} seed={p.seed} blocks={p.blocks}
      header={p.chrome ? (
...
export function RansomView(p: StoryViewData) {
  return (
    <FormatShell variant="ransom" accent={p.accent} artDirection={p.artDirection} seed={p.seed} blocks={p.blocks}
      header={p.chrome ? (
...
export function MarqueeView(p: StoryViewData) {
  return (
    <FormatShell variant="marquee" accent={p.accent} artDirection={p.artDirection} seed={p.seed} blocks={p.blocks}
      header={p.chrome ? (
...
export function PostcardView(p: StoryViewData) {
  return (
    <FormatShell variant="postcard-card" accent={p.accent} artDirection={p.artDirection} seed={p.seed} blocks={p.blocks}
      header={p.chrome ? (
