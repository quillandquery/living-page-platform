...
/**
 * `/about` (SEO/GEO/AEO audit, Sept 2026). Two gaps this closes at once:
 *
 * 1. GEO/AEO citability — the one clean, literal "Living Page is..."
 *    sentence a system could quote existed only in `llms.txt`, which a
 *    partial (if growing) share of crawlers actually fetch. This page puts
 *    the same real sentence — reused, not reworded — on an ordinary,
 *    fully-indexable HTML page any crawler or reader can land on.
 * 2. E-E-A-T Trustworthiness — there was no page anywhere stating what this
 *    is or how authorship/attribution works. This is deliberately plain
 *    prose, not homepage-style copy: the locked hero (docs/COPY.md) is
 *    untouched by this page.
 *
 * What this page does NOT add: a founder name, a company entity, or a
 * contact address — none of those exist as real information available to
 * add here, and this codebase's own rule for structured data (see
 * lib/structured-data.ts) is to never invent a fact. If a real "who runs
 * this / how to reach us" story exists, it belongs here next.
 */
...
.about-body h1{ font-family:var(--font-disp),Georgia,serif; font-weight:400;
  font-size:clamp(2rem,5vw,2.8rem); margin:0 0 1.6rem; }
.about-body h2{ font-family:var(--font-disp),Georgia,serif; font-weight:400;
