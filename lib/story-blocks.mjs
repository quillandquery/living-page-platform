 ...
 * @property {string} [ink]  world colour for this beat: "accent" | "accent2" | css colour
 * @property {boolean} [lineStart]  first sentence of a source line — the item boundary a list-piece groups on
 *
